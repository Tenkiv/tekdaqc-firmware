...
typedef enum {
	...
	COMMAND_HALT = 26,
	COMMAND_SET_RTC = 27,
	COMMAND_SET_USER_MAC = 28,
	COMMAND_SET_STATIC_IP = 29,
	COMMAND_GET_CALIBRATION_STATUS = 30,
	COMMAND_ENTER_CALIBRATION_MODE = 31,
	COMMAND_WRITE_GAIN_CAL_VALUE = 32,
	COMMAND_WRITE_CAL_MIN_TEMP = 33,
	COMMAND_WRITE_CAL_MAX_TEMP = 34,
	COMMAND_WRITE_CAL_DELTA_TEMP = 35,
