...
typedef enum {
	...
	COMMAND_READ_SYSTEM_GCAL = 10,
	COMMAND_LIST_DIGITAL_INPUTS = 11,
	COMMAND_READ_DIGITAL_INPUT = 12,
	COMMAND_ADD_DIGITAL_INPUT = 13,
	COMMAND_REMOVE_DIGITAL_INPUT = 14,
	COMMAND_LIST_DIGITAL_OUTPUTS = 15,
	COMMAND_SET_DIGITAL_OUTPUT = 16,
	COMMAND_READ_DIGITAL_OUTPUT = 17,
	COMMAND_ADD_DIGITAL_OUTPUT = 18,
	COMMAND_REMOVE_DIGITAL_OUTPUT = 19,
	COMMAND_CLEAR_DIG_OUTPUT_FAULT = 20,
	COMMAND_DISCONNECT = 21,
	COMMAND_UPGRADE = 22,
	COMMAND_IDENTIFY = 23,
	COMMAND_SAMPLE = 24,
	COMMAND_HALT = 25,
