...
static const uint8_t MINOR_VERSION = 0;  // New features
static const uint8_t BUILD_NUMBER  = 2;  // Bug fixes
static const uint8_t SPECIAL_BUILD = 1;  // Special unique release, otherwise 0
