...
typedef enum {
	...
	COMMAND_SYSTEM_CAL = 6,
	COMMAND_SYSTEM_GCAL = 7,
	COMMAND_READ_SYSTEM_GCAL = 8,
	COMMAND_LIST_DIGITAL_INPUTS = 9,
	COMMAND_READ_DIGITAL_INPUT = 10,
	COMMAND_ADD_DIGITAL_INPUT = 11,
	COMMAND_REMOVE_DIGITAL_INPUT = 12,
	COMMAND_LIST_DIGITAL_OUTPUTS = 13,
	COMMAND_SET_DIGITAL_OUTPUT = 14,
	COMMAND_READ_DIGITAL_OUTPUT = 15,
	COMMAND_ADD_DIGITAL_OUTPUT = 16,
	COMMAND_REMOVE_DIGITAL_OUTPUT = 17,
	COMMAND_CLEAR_DIG_OUTPUT_FAULT = 18,
	COMMAND_DISCONNECT = 19,
	COMMAND_UPGRADE = 20,
	COMMAND_IDENTIFY = 21,
	COMMAND_SAMPLE = 22,
	COMMAND_HALT = 23,
	COMMAND_SET_RTC = 24,
	COMMAND_SET_USER_MAC = 25,
	COMMAND_SET_STATIC_IP = 26,
	COMMAND_GET_CALIBRATION_STATUS = 27,
	COMMAND_NONE = 28
} Command_t;
