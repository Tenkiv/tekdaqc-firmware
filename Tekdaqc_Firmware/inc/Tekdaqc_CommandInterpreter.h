...
typedef enum {
	...
	COMMAND_HALT = 28,
	COMMAND_SET_RTC = 29,
	COMMAND_SET_USER_MAC = 30,
	COMMAND_CLEAR_USER_MAC = 31,
	COMMAND_SET_STATIC_IP = 32,
	COMMAND_GET_CALIBRATION_STATUS = 33,
	COMMAND_ENTER_CALIBRATION_MODE = 34,
	COMMAND_WRITE_GAIN_CAL_VALUE = 35,
	COMMAND_WRITE_CAL_TEMP = 36,
	COMMAND_WRITE_CAL_VALID = 37,
	COMMAND_EXIT_CALIBRATION_MODE = 38,
	COMMAND_SET_FACTORY_MAC_ADDR = 39,
	COMMAND_SET_BOARD_SERIAL_NUM = 40,
	COMMAND_NONE = 41
} Command_t;
