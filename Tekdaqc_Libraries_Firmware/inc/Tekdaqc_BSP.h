...
#define CALIBRATION_INPUT_RANGE_OFFSET	(CALIBRATION_BUFFER_OFFSET*NUM_BUFFER_SETTINGS)
#define CALIBRATION_TEMP_OFFSET			(CALIBRATION_INPUT_RANGE_OFFSET*NUM_INPUT_RANGES)
