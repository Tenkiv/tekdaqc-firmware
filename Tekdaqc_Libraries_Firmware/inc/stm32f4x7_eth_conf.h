...
#ifdef USE_Delay
#include "Tekdaqc_Timers.h"            		/* Header file where the Delay function prototype is exported */
#define _eth_delay_    (Delay_Periods_10MS) 	/* User can provide more timing precise _eth_delay_ function
