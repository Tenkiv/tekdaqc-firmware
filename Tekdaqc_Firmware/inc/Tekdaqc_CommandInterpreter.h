...
/**
 * @def PARAMETER_AVERAGE
 * @brief String constant definition for the AVERAGE parameter.
 */
...
typedef enum {
	...
	COMMAND_ADD_PWM_INPUT = 16,
	COMMAND_REMOVE_PWM_INPUT = 17,
	COMMAND_READ_PWM_INPUT = 18,
	COMMAND_LIST_PWM_INPUTs = 19,
	COMMAND_LIST_DIGITAL_OUTPUTS = 20,
	COMMAND_SET_DIGITAL_OUTPUT = 21,
	COMMAND_READ_DIGITAL_OUTPUT = 22,
	COMMAND_ADD_DIGITAL_OUTPUT = 23,
	COMMAND_REMOVE_DIGITAL_OUTPUT = 24,
	COMMAND_CLEAR_DIG_OUTPUT_FAULT = 25,
	COMMAND_SET_PWM_OUTPUT = 26,
	COMMAND_SET_PWM_OUTPUT_TIMER = 27,
	COMMAND_DISCONNECT = 28,
	COMMAND_REBOOT = 29,
	COMMAND_UPGRADE = 30,
	COMMAND_IDENTIFY = 31,
	COMMAND_SAMPLE = 32,
...
/**
 * @def NUM_ADD_PWM_INPUT_PARAMS
 * @brief The number of parameters for the ADD_PWM_INPUT_PARAMS command.
 */
#define NUM_ADD_PWM_INPUT_PARAMS 3
extern const char* ADD_PWM_INPUT_PARAMS[NUM_ADD_PWM_INPUT_PARAMS];
/**
 * @def NUM_ADD_PWM_INPUT_PARAMS
 * @brief The number of parameters for the ADD_PWM_INPUT_PARAMS command.
 */
#define NUM_REMOVE_PWM_INPUT_PARAMS 1
extern const char* REMOVE_PWM_INPUT_PARAMS[NUM_REMOVE_PWM_INPUT_PARAMS];
/**
 * @def NUM_READ_PWM_INPUT_PARAMS
 * @brief The number of parameters for the ADD_PWM_INPUT_PARAMS command.
 */
#define NUM_READ_PWM_INPUT_PARAMS 2
extern const char* READ_PWM_INPUT_PARAMS[NUM_READ_PWM_INPUT_PARAMS];
/**
 * @def NUM_READ_PWM_INPUT_PARAMS
 * @brief The number of parameters for the ADD_PWM_INPUT_PARAMS command.
 */
#define NUM_LIST_PWM_INPUTS_PARAMS 0
extern const char* LIST_PWM_INPUTS_PARAMS[NUM_LIST_PWM_INPUTS_PARAMS];
